...
/**
 * \file    test/phpunit/InvoicingorientedordersFunctionalTest.php
...
/**
 * Class InvoicingorientedordersFunctionalTest
 *
 ...
 *
 * @package Testinvoicingorientedorders
 */
class InvoicingorientedordersFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modInvoicingorientedorders')->click();
		} else {
			// Disable the module
			$this->byHref('modInvoicingorientedorders')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/invoicingorientedorders/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('invoicingorientedorders/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/invoicingorientedorders/admin/about.php');
		$this->authenticate();
		return $this->assertContains('invoicingorientedorders/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('invoicingorientedorderswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modInvoicingorientedorders_InvoicingorientedordersTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modInvoicingorientedorders_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
